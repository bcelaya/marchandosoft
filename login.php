        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    $username_err = "El usuario introducido no existe.";
                }
            } else{
                echo "Algo ha ido mal, prueba más tarde.";
            }
        }
...
<body>
    <div class="wrapper">
        <h2>Login</h2>
        <p>Para entrar en el sistema debe de introducir las siguientes credenciales:</p>
